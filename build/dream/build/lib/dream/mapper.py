...
class Mapper(Node):
    ...
    def save_to_file(self, filepath='mapper_output.txt'):
        with open(filepath, 'w') as f:
            ...
            f.write(f"Max Linear Velocity: {self.max_linear_velocity:.6f} m/s\n")
            f.write(f"Min Linear Velocity: {self.min_linear_velocity:.6f} m/s\n")
            f.write(f"Max Steering Angle:  {self.max_steering_angle:.6f} rad\n")

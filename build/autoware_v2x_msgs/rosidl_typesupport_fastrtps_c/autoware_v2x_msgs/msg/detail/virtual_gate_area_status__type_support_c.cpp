...
#include "autoware_v2x_msgs/msg/detail/virtual_gate_area_status__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // expected_time_arrival, stamp
...
using _VirtualGateAreaStatus__ros_msg_type = autoware_v2x_msgs__msg__VirtualGateAreaStatus;

static bool _VirtualGateAreaStatus__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VirtualGateAreaStatus__ros_msg_type * ros_message = static_cast<const _VirtualGateAreaStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
...
static bool _VirtualGateAreaStatus__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _VirtualGateAreaStatus__ros_msg_type * ros_message = static_cast<_VirtualGateAreaStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _VirtualGateAreaStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_v2x_msgs__msg__VirtualGateAreaStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_v2x_msgs__msg__VirtualGateAreaStatus;
    is_plain =
      (
...
static size_t _VirtualGateAreaStatus__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_autoware_v2x_msgs__msg__VirtualGateAreaStatus(
...
static message_type_support_callbacks_t __callbacks_VirtualGateAreaStatus = {
  "autoware_v2x_msgs::msg",
  "VirtualGateAreaStatus",
  _VirtualGateAreaStatus__cdr_serialize,
  _VirtualGateAreaStatus__cdr_deserialize,
  _VirtualGateAreaStatus__get_serialized_size,
  _VirtualGateAreaStatus__max_serialized_size
};

static rosidl_message_type_support_t _VirtualGateAreaStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VirtualGateAreaStatus,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_v2x_msgs, msg, VirtualGateAreaStatus)() {
  return &_VirtualGateAreaStatus__type_support;
}

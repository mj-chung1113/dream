...
bool autoware_v2x_msgs__msg__virtual_gate_area_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_v2x_msgs.msg._virtual_gate_area_command.VirtualGateAreaCommand", full_classname_dest, 71) == 0);
  }
  autoware_v2x_msgs__msg__VirtualGateAreaCommand * ros_message = _ros_message;
  {  // command
...
{
  /* NOTE(esteve): Call constructor of VirtualGateAreaCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_v2x_msgs.msg._virtual_gate_area_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VirtualGateAreaCommand");

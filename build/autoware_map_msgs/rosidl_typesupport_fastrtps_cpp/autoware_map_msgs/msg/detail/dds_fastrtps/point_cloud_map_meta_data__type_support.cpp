...
#include "autoware_map_msgs/msg/detail/point_cloud_map_meta_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_map_msgs::msg::PointCloudMapCellMetaDataWithID &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: metadata_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_map_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PointCloudMapCellMetaDataWithID(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_map_msgs::msg::PointCloudMapMetaData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_map_msgs::msg::PointCloudMapMetaData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_map_msgs::msg::PointCloudMapMetaData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PointCloudMapMetaData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_map_msgs::msg::PointCloudMapMetaData *>(
...
static size_t _PointCloudMapMetaData__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PointCloudMapMetaData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PointCloudMapMetaData__callbacks = {
...
static rosidl_message_type_support_t _PointCloudMapMetaData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PointCloudMapMetaData__callbacks,
...
{
  return &autoware_map_msgs::msg::typesupport_fastrtps_cpp::_PointCloudMapMetaData__handle;
}

...
#include "autoware_map_msgs/srv/detail/get_partial_point_cloud_map__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_map_msgs::srv::GetPartialPointCloudMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_map_msgs::srv::GetPartialPointCloudMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_map_msgs::srv::GetPartialPointCloudMap_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetPartialPointCloudMap_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_map_msgs::srv::GetPartialPointCloudMap_Request *>(
...
static size_t _GetPartialPointCloudMap_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetPartialPointCloudMap_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetPartialPointCloudMap_Request__callbacks = {
...
static rosidl_message_type_support_t _GetPartialPointCloudMap_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetPartialPointCloudMap_Request__callbacks,
...
{
  return &autoware_map_msgs::srv::typesupport_fastrtps_cpp::_GetPartialPointCloudMap_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_map_msgs::srv::GetPartialPointCloudMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_map_msgs::srv::GetPartialPointCloudMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autoware_map_msgs::srv::GetPartialPointCloudMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetPartialPointCloudMap_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_map_msgs::srv::GetPartialPointCloudMap_Response *>(
...
static size_t _GetPartialPointCloudMap_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetPartialPointCloudMap_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetPartialPointCloudMap_Response__callbacks = {
  "autoware_map_msgs::srv",
...
static rosidl_message_type_support_t _GetPartialPointCloudMap_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetPartialPointCloudMap_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &autoware_map_msgs::srv::typesupport_fastrtps_cpp::_GetPartialPointCloudMap_Response__handle;
}
...
static service_type_support_callbacks_t _GetPartialPointCloudMap__callbacks = {
  "autoware_map_msgs::srv",
...
static rosidl_service_type_support_t _GetPartialPointCloudMap__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetPartialPointCloudMap__callbacks,
...
{
  return &autoware_map_msgs::srv::typesupport_fastrtps_cpp::_GetPartialPointCloudMap__handle;
}

  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_map_msgs__srv__GetDifferentialPointCloudMap_Request;
    is_plain =
      (
      offsetof(DataType, cached_ids) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GetDifferentialPointCloudMap_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_autoware_map_msgs__srv__GetDifferentialPointCloudMap_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_map_msgs__srv__GetDifferentialPointCloudMap_Response;
    is_plain =
      (
      offsetof(DataType, ids_to_remove) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GetDifferentialPointCloudMap_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_autoware_map_msgs__srv__GetDifferentialPointCloudMap_Response(
    full_bounded, is_plain, 0);

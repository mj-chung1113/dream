  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_map_msgs__msg__PointCloudMapCellMetaDataWithID;
    is_plain =
      (
...
static size_t _PointCloudMapCellMetaDataWithID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_map_msgs__msg__PointCloudMapCellMetaDataWithID(

...
static const _GetPartialPointCloudMap_Request_type_support_symbol_names_t _GetPartialPointCloudMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap_Request)),
  }
};
...
{
  return &::autoware_map_msgs::srv::rosidl_typesupport_cpp::GetPartialPointCloudMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap_Request)() {
  return get_message_type_support_handle<autoware_map_msgs::srv::GetPartialPointCloudMap_Request>();
}
...
static const _GetPartialPointCloudMap_Response_type_support_symbol_names_t _GetPartialPointCloudMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap_Response)),
  }
};
...
{
  return &::autoware_map_msgs::srv::rosidl_typesupport_cpp::GetPartialPointCloudMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap_Response)() {
  return get_message_type_support_handle<autoware_map_msgs::srv::GetPartialPointCloudMap_Response>();
}
...
static const _GetPartialPointCloudMap_type_support_symbol_names_t _GetPartialPointCloudMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap)),
  }
};
...
{
  return &::autoware_map_msgs::srv::rosidl_typesupport_cpp::GetPartialPointCloudMap_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_map_msgs, srv, GetPartialPointCloudMap)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<autoware_map_msgs::srv::GetPartialPointCloudMap>();
}

...
enum
{
  autoware_perception_msgs__msg__ObjectClassification__ANIMAL = 8
};
...
enum
{
  autoware_perception_msgs__msg__ObjectClassification__HAZARD = 9
};
...
enum
{
  autoware_perception_msgs__msg__ObjectClassification__OVER_DRIVABLE = 10
};
...
enum
{
  autoware_perception_msgs__msg__ObjectClassification__UNDER_DRIVABLE = 11
};

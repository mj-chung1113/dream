...
{
  new (message_memory) autoware_perception_msgs::msg::TrackedObject(_init);
}

void TrackedObject_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::TrackedObject *>(message_memory);
...
{
  const auto & item = *reinterpret_cast<const autoware_perception_msgs::msg::ObjectClassification *>(
    get_const_function__TrackedObject__classification(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_perception_msgs::msg::ObjectClassification *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_perception_msgs::msg::ObjectClassification *>(
    get_function__TrackedObject__classification(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_perception_msgs::msg::ObjectClassification *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrackedObject_message_member_array[5] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::TrackedObject, object_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObject, existence_probability),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObject, classification),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_perception_msgs::msg::TrackedObjectKinematics>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObject, kinematics),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObject, shape),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrackedObject_message_members = {
  ...
  5,  // number of fields
  sizeof(autoware_perception_msgs::msg::TrackedObject),
...
get_message_type_support_handle<autoware_perception_msgs::msg::TrackedObject>()
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrackedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, TrackedObject)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrackedObject_message_type_support_handle;
}

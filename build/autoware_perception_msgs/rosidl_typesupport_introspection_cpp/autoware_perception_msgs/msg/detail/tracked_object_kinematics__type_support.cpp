...
{
  new (message_memory) autoware_perception_msgs::msg::TrackedObjectKinematics(_init);
}

void TrackedObjectKinematics_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::TrackedObjectKinematics *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrackedObjectKinematics_message_member_array[5] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::TrackedObjectKinematics, pose_with_covariance),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObjectKinematics, twist_with_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObjectKinematics, acceleration_with_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObjectKinematics, orientation_availability),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObjectKinematics, is_stationary),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrackedObjectKinematics_message_members = {
  ...
  5,  // number of fields
  sizeof(autoware_perception_msgs::msg::TrackedObjectKinematics),
...
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrackedObjectKinematics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, TrackedObjectKinematics)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrackedObjectKinematics_message_type_support_handle;
}

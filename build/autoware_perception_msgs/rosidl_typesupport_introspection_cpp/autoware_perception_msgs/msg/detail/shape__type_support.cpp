...
{
  new (message_memory) autoware_perception_msgs::msg::Shape(_init);
}

void Shape_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::Shape *>(message_memory);
  typed_message->~Shape();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Shape_message_member_array[3] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::Shape, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::Shape, footprint),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::Shape, dimensions),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Shape_message_members = {
  ...
  "Shape",  // message name
  3,  // number of fields
  sizeof(autoware_perception_msgs::msg::Shape),
...
get_message_type_support_handle<autoware_perception_msgs::msg::Shape>()
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Shape_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, Shape)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Shape_message_type_support_handle;
}

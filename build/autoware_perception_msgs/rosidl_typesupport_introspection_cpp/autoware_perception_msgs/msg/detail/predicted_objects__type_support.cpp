...
{
  new (message_memory) autoware_perception_msgs::msg::PredictedObjects(_init);
}

void PredictedObjects_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::PredictedObjects *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PredictedObjects_message_member_array[2] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::PredictedObjects, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::PredictedObjects, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PredictedObjects_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_perception_msgs::msg::PredictedObjects),
...
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::PredictedObjects_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, PredictedObjects)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::PredictedObjects_message_type_support_handle;
}

...
{
  new (message_memory) autoware_perception_msgs::msg::PredictedObjectKinematics(_init);
}

void PredictedObjectKinematics_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::PredictedObjectKinematics *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<autoware_perception_msgs::msg::PredictedPath> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_perception_msgs::msg::PredictedPath> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_perception_msgs::msg::PredictedPath> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const autoware_perception_msgs::msg::PredictedPath *>(
    get_const_function__PredictedObjectKinematics__predicted_paths(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_perception_msgs::msg::PredictedPath *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_perception_msgs::msg::PredictedPath *>(
    get_function__PredictedObjectKinematics__predicted_paths(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_perception_msgs::msg::PredictedPath *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PredictedObjectKinematics_message_member_array[4] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::PredictedObjectKinematics, initial_pose_with_covariance),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::PredictedObjectKinematics, initial_twist_with_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::PredictedObjectKinematics, initial_acceleration_with_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_perception_msgs::msg::PredictedPath>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::PredictedObjectKinematics, predicted_paths),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PredictedObjectKinematics_message_members = {
  ...
  4,  // number of fields
  sizeof(autoware_perception_msgs::msg::PredictedObjectKinematics),
...
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::PredictedObjectKinematics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, PredictedObjectKinematics)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::PredictedObjectKinematics_message_type_support_handle;
}

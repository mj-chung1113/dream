...
{
  new (message_memory) autoware_perception_msgs::msg::TrackedObjects(_init);
}

void TrackedObjects_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_perception_msgs::msg::TrackedObjects *>(message_memory);
  typed_message->~TrackedObjects();
}

size_t size_function__TrackedObjects__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_perception_msgs::msg::TrackedObject> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_perception_msgs::msg::TrackedObject> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_perception_msgs::msg::TrackedObject> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const autoware_perception_msgs::msg::TrackedObject *>(
    get_const_function__TrackedObjects__objects(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_perception_msgs::msg::TrackedObject *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_perception_msgs::msg::TrackedObject *>(
    get_function__TrackedObjects__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_perception_msgs::msg::TrackedObject *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrackedObjects_message_member_array[2] = {
  {
    ...
    offsetof(autoware_perception_msgs::msg::TrackedObjects, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_perception_msgs::msg::TrackedObject>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_perception_msgs::msg::TrackedObjects, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrackedObjects_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_perception_msgs::msg::TrackedObjects),
...
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrackedObjects_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, TrackedObjects)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrackedObjects_message_type_support_handle;
}

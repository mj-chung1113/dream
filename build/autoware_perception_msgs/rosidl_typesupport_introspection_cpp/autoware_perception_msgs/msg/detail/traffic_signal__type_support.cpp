...
{
  const auto * member = reinterpret_cast<const std::vector<autoware_perception_msgs::msg::TrafficSignalElement> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_perception_msgs::msg::TrafficSignalElement> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_perception_msgs::msg::TrafficSignalElement> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const autoware_perception_msgs::msg::TrafficSignalElement *>(
    get_const_function__TrafficSignal__elements(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_perception_msgs::msg::TrafficSignalElement *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<autoware_perception_msgs::msg::TrafficSignalElement *>(
    get_function__TrafficSignal__elements(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_perception_msgs::msg::TrafficSignalElement *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficSignal_message_member_array[2] = {
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_perception_msgs::msg::TrafficSignalElement>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound

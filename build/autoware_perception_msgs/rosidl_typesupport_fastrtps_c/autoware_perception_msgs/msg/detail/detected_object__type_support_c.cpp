...
#include "autoware_perception_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_perception_msgs/msg/detail/detected_object_kinematics__functions.h"  // kinematics
...
size_t get_serialized_size_autoware_perception_msgs__msg__DetectedObjectKinematics(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_autoware_perception_msgs__msg__DetectedObjectKinematics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_perception_msgs, msg, DetectedObjectKinematics)();
...
using _DetectedObject__ros_msg_type = autoware_perception_msgs__msg__DetectedObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: kinematics
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_perception_msgs, msg, DetectedObjectKinematics
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_autoware_perception_msgs__msg__DetectedObjectKinematics(
...
static uint32_t _DetectedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_perception_msgs__msg__DetectedObject(
  ...
  size_t current_alignment)
{
  ...
  // member: kinematics
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_autoware_perception_msgs__msg__DetectedObjectKinematics(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs__msg__DetectedObject;
    is_plain =
      (
...
static size_t _DetectedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_perception_msgs__msg__DetectedObject(

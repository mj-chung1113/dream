...
#include "autoware_perception_msgs/msg/detail/predicted_path__rosidl_typesupport_fastrtps_c.h"
...
using _PredictedPath__ros_msg_type = autoware_perception_msgs__msg__PredictedPath;
...
static uint32_t _PredictedPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_perception_msgs__msg__PredictedPath(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs__msg__PredictedPath;
    is_plain =
      (
...
static size_t _PredictedPath__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_perception_msgs__msg__PredictedPath(

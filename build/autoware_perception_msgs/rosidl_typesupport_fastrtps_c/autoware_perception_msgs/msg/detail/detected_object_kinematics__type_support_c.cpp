...
#include "autoware_perception_msgs/msg/detail/detected_object_kinematics__rosidl_typesupport_fastrtps_c.h"
...
using _DetectedObjectKinematics__ros_msg_type = autoware_perception_msgs__msg__DetectedObjectKinematics;
...
static uint32_t _DetectedObjectKinematics__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_perception_msgs__msg__DetectedObjectKinematics(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs__msg__DetectedObjectKinematics;
    is_plain =
      (
...
static size_t _DetectedObjectKinematics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_perception_msgs__msg__DetectedObjectKinematics(

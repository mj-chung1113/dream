...
#include "autoware_perception_msgs/msg/detail/predicted_object_kinematics__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_perception_msgs/msg/detail/predicted_path__functions.h"  // predicted_paths
#include "geometry_msgs/msg/detail/accel_with_covariance__functions.h"  // initial_acceleration_with_covariance
#include "geometry_msgs/msg/detail/pose_with_covariance__functions.h"  // initial_pose_with_covariance
#include "geometry_msgs/msg/detail/twist_with_covariance__functions.h"  // initial_twist_with_covariance

// forward declare type support functions
size_t get_serialized_size_autoware_perception_msgs__msg__PredictedPath(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_autoware_perception_msgs__msg__PredictedPath(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_perception_msgs, msg, PredictedPath)();
...
using _PredictedObjectKinematics__ros_msg_type = autoware_perception_msgs__msg__PredictedObjectKinematics;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: initial_pose_with_covariance
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->initial_pose_with_covariance, cdr))
    {
      return false;
    }
  }

  // Field name: initial_twist_with_covariance
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->initial_twist_with_covariance, cdr))
    {
      return false;
    }
  }

  // Field name: initial_acceleration_with_covariance
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->initial_acceleration_with_covariance, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: predicted_paths
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_perception_msgs, msg, PredictedPath
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: predicted_paths
  {
    ...
    if (ros_message->predicted_paths.data) {
      autoware_perception_msgs__msg__PredictedPath__Sequence__fini(&ros_message->predicted_paths);
    }
    if (!autoware_perception_msgs__msg__PredictedPath__Sequence__init(&ros_message->predicted_paths, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name predicted_paths
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_autoware_perception_msgs__msg__PredictedPath(
...
static uint32_t _PredictedObjectKinematics__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_perception_msgs__msg__PredictedObjectKinematics(
  ...
  size_t current_alignment)
{
  ...
  // member: predicted_paths
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_autoware_perception_msgs__msg__PredictedPath(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs__msg__PredictedObjectKinematics;
    is_plain =
      (
...
static size_t _PredictedObjectKinematics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_perception_msgs__msg__PredictedObjectKinematics(

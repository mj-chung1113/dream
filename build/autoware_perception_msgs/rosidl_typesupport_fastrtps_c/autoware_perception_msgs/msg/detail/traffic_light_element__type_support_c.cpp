...
#include "autoware_perception_msgs/msg/detail/traffic_light_element__rosidl_typesupport_fastrtps_c.h"
...
using _TrafficLightElement__ros_msg_type = autoware_perception_msgs__msg__TrafficLightElement;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrafficLightElement__ros_msg_type * ros_message = static_cast<const _TrafficLightElement__ros_msg_type *>(untyped_ros_message);
  // Field name: color
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrafficLightElement__ros_msg_type * ros_message = static_cast<_TrafficLightElement__ros_msg_type *>(untyped_ros_message);
  // Field name: color
  {
    cdr >> ros_message->color;
  }
...
static uint32_t _TrafficLightElement__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_perception_msgs__msg__TrafficLightElement(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs__msg__TrafficLightElement;
    is_plain =
      (
...
static size_t _TrafficLightElement__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_perception_msgs__msg__TrafficLightElement(
...
static message_type_support_callbacks_t __callbacks_TrafficLightElement = {
...
static rosidl_message_type_support_t _TrafficLightElement__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrafficLightElement,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_perception_msgs, msg, TrafficLightElement)() {
  return &_TrafficLightElement__type_support;
}

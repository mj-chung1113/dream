...
class Metaclass_PredictedObject(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_perception_msgs.msg import PredictedObjectKinematics
...
class PredictedObject(metaclass=Metaclass_PredictedObject):
    ...
    _fields_and_field_types = {
        ...
        'kinematics': 'autoware_perception_msgs/PredictedObjectKinematics',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['autoware_perception_msgs', 'msg'], 'PredictedObjectKinematics'),  # noqa: E501

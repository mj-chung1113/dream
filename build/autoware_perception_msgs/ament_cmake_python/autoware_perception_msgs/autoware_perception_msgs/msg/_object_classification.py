...
class Metaclass_ObjectClassification(type):
    ...
    def HAZARD(self):
        ...
        return Metaclass_ObjectClassification.__constants['HAZARD']

    @property
    def OVER_DRIVABLE(self):
        """Message constant 'OVER_DRIVABLE'."""
        return Metaclass_ObjectClassification.__constants['OVER_DRIVABLE']

    @property
    def UNDER_DRIVABLE(self):
        """Message constant 'UNDER_DRIVABLE'."""
        return Metaclass_ObjectClassification.__constants['UNDER_DRIVABLE']

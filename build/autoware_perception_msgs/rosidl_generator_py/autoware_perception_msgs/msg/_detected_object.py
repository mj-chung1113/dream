...
class Metaclass_DetectedObject(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if DetectedObjectKinematics.__class__._TYPE_SUPPORT is None:
                DetectedObjectKinematics.__class__.__import_type_support__()
...
class DetectedObject(metaclass=Metaclass_DetectedObject):
    ...
    _fields_and_field_types = {
        ...
        'classification': 'sequence<autoware_perception_msgs/ObjectClassification>',
        'kinematics': 'autoware_perception_msgs/DetectedObjectKinematics',
        'shape': 'autoware_perception_msgs/Shape',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_perception_msgs', 'msg'], 'ObjectClassification')),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['autoware_perception_msgs', 'msg'], 'DetectedObjectKinematics'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['autoware_perception_msgs', 'msg'], 'Shape'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from autoware_perception_msgs.msg import DetectedObjectKinematics
        self.kinematics = kwargs.get('kinematics', DetectedObjectKinematics())
        from autoware_perception_msgs.msg import Shape
    ...
    def kinematics(self, value):
        if __debug__:
            from autoware_perception_msgs.msg import DetectedObjectKinematics
            assert \
                isinstance(value, DetectedObjectKinematics), \
                "The 'kinematics' field must be a sub message of type 'DetectedObjectKinematics'"

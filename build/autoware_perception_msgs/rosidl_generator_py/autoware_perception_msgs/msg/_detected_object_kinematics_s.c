...
bool autoware_perception_msgs__msg__detected_object_kinematics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_perception_msgs.msg._detected_object_kinematics.DetectedObjectKinematics", full_classname_dest, 81) == 0);
  }
  autoware_perception_msgs__msg__DetectedObjectKinematics * ros_message = _ros_message;
...
PyObject * autoware_perception_msgs__msg__detected_object_kinematics__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_perception_msgs.msg._detected_object_kinematics");

...
static const _PredictedObjectKinematics_type_support_symbol_names_t _PredictedObjectKinematics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_perception_msgs, msg, PredictedObjectKinematics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_perception_msgs, msg, PredictedObjectKinematics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_perception_msgs, msg, PredictedObjectKinematics)() {
  return &::autoware_perception_msgs::msg::rosidl_typesupport_c::PredictedObjectKinematics_message_type_support_handle;
}

...
#include "autoware_perception_msgs/msg/detail/traffic_signal__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_perception_msgs::msg::TrafficSignalElement &,
  ...
  size_t current_alignment)
{
  ...
  // Member: elements
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficSignalElement(
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs::msg::TrafficSignal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::TrafficSignal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_perception_msgs::msg::TrafficSignal *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrafficSignal__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::TrafficSignal *>(
...
static size_t _TrafficSignal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrafficSignal(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrafficSignal__callbacks = {
...
static rosidl_message_type_support_t _TrafficSignal__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrafficSignal__callbacks,
...
{
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficSignal__handle;
}

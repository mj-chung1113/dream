...
#include "autoware_perception_msgs/msg/detail/shape__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_perception_msgs::msg::Shape & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_perception_msgs::msg::Shape & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs::msg::Shape;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::Shape *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_perception_msgs::msg::Shape *>(
    untyped_ros_message);
...
{
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_Shape__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_perception_msgs, msg, Shape)() {
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_Shape__handle;
}

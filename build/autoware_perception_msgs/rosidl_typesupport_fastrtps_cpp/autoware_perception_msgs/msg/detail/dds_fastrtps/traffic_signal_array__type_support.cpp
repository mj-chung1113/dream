...
#include "autoware_perception_msgs/msg/detail/traffic_signal_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_perception_msgs::msg::TrafficSignal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autoware_perception_msgs::msg::TrafficSignalArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_perception_msgs::msg::TrafficSignalArray & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  // Member: signals
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficSignal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs::msg::TrafficSignalArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::TrafficSignalArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_perception_msgs::msg::TrafficSignalArray *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_perception_msgs::msg::TrafficSignalArray>()
{
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficSignalArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_perception_msgs, msg, TrafficSignalArray)() {
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficSignalArray__handle;
}

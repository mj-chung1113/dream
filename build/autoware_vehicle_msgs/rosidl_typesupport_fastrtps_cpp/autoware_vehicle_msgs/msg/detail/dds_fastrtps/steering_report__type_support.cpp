...
cdr_serialize(
  const autoware_vehicle_msgs::msg::SteeringReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_vehicle_msgs::msg::SteeringReport & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_vehicle_msgs::msg::SteeringReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_vehicle_msgs::msg::SteeringReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_vehicle_msgs::msg::SteeringReport *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_vehicle_msgs::msg::SteeringReport>()
{
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_SteeringReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_vehicle_msgs, msg, SteeringReport)() {
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_SteeringReport__handle;
}

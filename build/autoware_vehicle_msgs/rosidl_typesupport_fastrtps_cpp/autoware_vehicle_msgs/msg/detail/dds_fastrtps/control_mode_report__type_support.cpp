...
cdr_serialize(
  const autoware_vehicle_msgs::msg::ControlModeReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_vehicle_msgs::msg::ControlModeReport & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_vehicle_msgs::msg::ControlModeReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_vehicle_msgs::msg::ControlModeReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_vehicle_msgs::msg::ControlModeReport *>(
    untyped_ros_message);
...
static size_t _ControlModeReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ControlModeReport(full_bounded, is_plain, 0);
...
get_message_type_support_handle<autoware_vehicle_msgs::msg::ControlModeReport>()
{
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_ControlModeReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_vehicle_msgs, msg, ControlModeReport)() {
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_ControlModeReport__handle;
}

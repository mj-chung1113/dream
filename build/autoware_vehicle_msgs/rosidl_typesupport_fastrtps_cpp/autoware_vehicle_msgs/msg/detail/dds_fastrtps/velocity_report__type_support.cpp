  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_vehicle_msgs::msg::VelocityReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_vehicle_msgs::msg::VelocityReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_vehicle_msgs::msg::VelocityReport *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_vehicle_msgs::msg::VelocityReport>()
{
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_VelocityReport__handle;
}

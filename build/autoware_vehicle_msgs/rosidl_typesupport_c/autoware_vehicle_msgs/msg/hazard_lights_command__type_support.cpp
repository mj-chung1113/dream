...
#include "autoware_vehicle_msgs/msg/detail/hazard_lights_command__type_support.h"
...
static const _HazardLightsCommand_type_support_symbol_names_t _HazardLightsCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, msg, HazardLightsCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_vehicle_msgs, msg, HazardLightsCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_vehicle_msgs, msg, HazardLightsCommand)() {
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_c::HazardLightsCommand_message_type_support_handle;
}

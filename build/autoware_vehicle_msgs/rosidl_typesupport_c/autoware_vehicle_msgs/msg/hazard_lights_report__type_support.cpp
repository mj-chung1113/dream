...
#include "autoware_vehicle_msgs/msg/detail/hazard_lights_report__type_support.h"
...
static const _HazardLightsReport_type_support_symbol_names_t _HazardLightsReport_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, msg, HazardLightsReport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_vehicle_msgs, msg, HazardLightsReport)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_vehicle_msgs, msg, HazardLightsReport)() {
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_c::HazardLightsReport_message_type_support_handle;
}

...
#include "autoware_vehicle_msgs/msg/detail/turn_indicators_command__type_support.h"
...
static const _TurnIndicatorsCommand_type_support_symbol_names_t _TurnIndicatorsCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, msg, TurnIndicatorsCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_vehicle_msgs, msg, TurnIndicatorsCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_vehicle_msgs, msg, TurnIndicatorsCommand)() {
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_c::TurnIndicatorsCommand_message_type_support_handle;
}

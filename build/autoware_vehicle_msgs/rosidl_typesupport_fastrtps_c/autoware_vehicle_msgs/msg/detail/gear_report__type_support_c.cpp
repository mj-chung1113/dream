...
#include "autoware_vehicle_msgs/msg/detail/gear_report__rosidl_typesupport_fastrtps_c.h"
...
using _GearReport__ros_msg_type = autoware_vehicle_msgs__msg__GearReport;
...
size_t get_serialized_size_autoware_vehicle_msgs__msg__GearReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GearReport__ros_msg_type * ros_message = static_cast<const _GearReport__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GearReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_vehicle_msgs__msg__GearReport(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_vehicle_msgs
size_t max_serialized_size_autoware_vehicle_msgs__msg__GearReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_vehicle_msgs__msg__GearReport;
    is_plain =
      (
...
static size_t _GearReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_vehicle_msgs__msg__GearReport(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, msg, GearReport)() {

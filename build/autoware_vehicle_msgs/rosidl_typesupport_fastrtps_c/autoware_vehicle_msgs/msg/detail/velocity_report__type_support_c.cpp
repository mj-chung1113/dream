...
#include "autoware_vehicle_msgs/msg/detail/velocity_report__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_vehicle_msgs/msg/detail/velocity_report__functions.h"
...
using _VelocityReport__ros_msg_type = autoware_vehicle_msgs__msg__VelocityReport;
...
size_t get_serialized_size_autoware_vehicle_msgs__msg__VelocityReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VelocityReport__ros_msg_type * ros_message = static_cast<const _VelocityReport__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VelocityReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_vehicle_msgs__msg__VelocityReport(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_vehicle_msgs
size_t max_serialized_size_autoware_vehicle_msgs__msg__VelocityReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_vehicle_msgs__msg__VelocityReport;
    is_plain =
      (
...
static size_t _VelocityReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_vehicle_msgs__msg__VelocityReport(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, msg, VelocityReport)() {

...
#include "autoware_vehicle_msgs/srv/detail/control_mode_command__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_vehicle_msgs/srv/detail/control_mode_command__functions.h"
...
using _ControlModeCommand_Request__ros_msg_type = autoware_vehicle_msgs__srv__ControlModeCommand_Request;
...
size_t get_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControlModeCommand_Request__ros_msg_type * ros_message = static_cast<const _ControlModeCommand_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ControlModeCommand_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_vehicle_msgs
size_t max_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_vehicle_msgs__srv__ControlModeCommand_Request;
    is_plain =
      (
...
static size_t _ControlModeCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, srv, ControlModeCommand_Request)() {
...
using _ControlModeCommand_Response__ros_msg_type = autoware_vehicle_msgs__srv__ControlModeCommand_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_vehicle_msgs
size_t get_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControlModeCommand_Response__ros_msg_type * ros_message = static_cast<const _ControlModeCommand_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_vehicle_msgs
size_t max_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_vehicle_msgs__srv__ControlModeCommand_Response;
    is_plain =
      (
...
static size_t _ControlModeCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, srv, ControlModeCommand_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, srv, ControlModeCommand)() {

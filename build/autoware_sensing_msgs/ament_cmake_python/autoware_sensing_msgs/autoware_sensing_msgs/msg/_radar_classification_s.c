...
bool autoware_sensing_msgs__msg__radar_classification__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_sensing_msgs.msg._radar_classification.RadarClassification", full_classname_dest, 67) == 0);
  }
  autoware_sensing_msgs__msg__RadarClassification * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of RadarClassification */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_sensing_msgs.msg._radar_classification");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RadarClassification");

...
class PredictedObjectKinematics(metaclass=Metaclass_PredictedObjectKinematics):
    ...
    _fields_and_field_types = {
        ...
        'predicted_paths': 'sequence<autoware_perception_msgs/PredictedPath>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_perception_msgs', 'msg'], 'PredictedPath')),  # noqa: E501
    )

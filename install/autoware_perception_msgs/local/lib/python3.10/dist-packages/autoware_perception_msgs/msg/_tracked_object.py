...
class TrackedObject(metaclass=Metaclass_TrackedObject):
    ...
    _fields_and_field_types = {
        ...
        'kinematics': 'autoware_perception_msgs/TrackedObjectKinematics',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['autoware_perception_msgs', 'msg'], 'TrackedObjectKinematics'),  # noqa: E501
